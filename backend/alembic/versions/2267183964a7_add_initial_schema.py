...
def upgrade() -> None:
    ...
    op.create_table('kg_category',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    sa.Column('name', sa.Enum('FUND', 'TECH', 'MANPOWER', 'EXPORT', 'SALES', 'STARTUP', 'MANAGEMENT', 'COMMERCIALIZATION', 'INCUBATION', 'EDUCATION', 'EVENT', name='category_name'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('notice_source',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    op.create_table('category_mapping',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    sa.Column('raw_category', sa.String(length=100), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('category_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['kg_category.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['source_id'], ['notice_source.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('bizinfo_raw',
    sa.Column('Key', sa.String(length=255), nullable=False),
    sa.Column('Field', sa.String(length=255), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['notice.id'], ),
    sa.PrimaryKeyConstraint('Key')
    )
    op.create_table('business_plan',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    op.create_table('notice_attachment',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    op.create_table('notice_category_map',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    sa.Column('notice_id', sa.Integer(), nullable=False),
    ...
    op.create_table('notice_target_type',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    sa.Column('notice_id', sa.Integer(), nullable=False),
    ...
    op.create_table('refined_column',
    sa.Column('Key', sa.String(length=255), nullable=False),
    sa.Column('Field', sa.String(length=255), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['notice.id'], ),
    ...
    op.create_table('business_plan_chunk',
    sa.Column('id', sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['business_plan_id'], ['business_plan.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['match_run_id'], ['match_log.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('business_fit_score', sa.Numeric(precision=5, scale=2), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['notice_id'], ['notice.id'], ),
    sa.ForeignKeyConstraint(['recommendation_run_id'], ['match_log.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
