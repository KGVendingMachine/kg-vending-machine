...
- support.summary에는 "무엇을(지원 내용) + 얼마를(금액/한도, 있으면) + 어떤 방식으로(출연/융자/바우처 등 지급 방식)" 지원하는지 한 문장으로 반드시 요약하세요. "기술고도화 및 지원"처럼 금액·방식 없이 뭉뚱그린 요약은 잘못된 출력입니다. 세부 지원 항목은 support.support_content에 배열로 나누어 작성하세요.
